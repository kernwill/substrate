...
// <runtime>/aws_s3.json, <runtime>/aws_iam.json, and
// <runtime>/aws_cloudtrail.json back in, maps them through the same
// awscollectors.ToIR/IAMToIR/CloudTrailToIR this package's own
