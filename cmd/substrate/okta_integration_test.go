...
func TestOktaEvidenceFlowsThroughRealCompile(t *testing.T) {
	...
	if _, err := writeCollectOutput(runtimeDir, &awscollectors.S3Graph{}, &awscollectors.IAMGraph{}, &awscollectors.CloudTrailGraph{}, &awscollectors.SecurityGroupsGraph{}, &awscollectors.SubnetsGraph{}, &awscollectors.GuardDutyGraph{}, &awscollectors.ConfigGraph{}, &awscollectors.SecurityHubGraph{}, &awscollectors.KMSGraph{}, okta); err != nil {
